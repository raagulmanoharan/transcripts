...
- factors: the 2-3 discrete signal fragments you fused, each 2-4 words ("rain at 9:10", "9:30 standup", "still home"). These are shown as small evidence chips. Keep each short enough to read at a glance.
- icon: one glyph name that best represents the move, from exactly: rain, sun, cloud, message, note, walk, battery, clock, location, calendar, moon, idea, check.
